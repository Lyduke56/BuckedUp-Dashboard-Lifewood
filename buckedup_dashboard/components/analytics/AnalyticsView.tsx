              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--ink-soft)] leading-relaxed">
                      Products and stages are edited directly in this dashboard by signed-in editors and admins, and sync live via Supabase — there is no external Sheet anymore.
                    </p>
                  </div>
                </div>
              </div>

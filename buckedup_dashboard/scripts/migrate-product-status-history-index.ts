...
const SQL = `
CREATE INDEX IF NOT EXISTS product_status_history_product_entered_idx
  ON product_status_history (product_id, entered_at DESC);

CREATE INDEX IF NOT EXISTS product_status_history_entered_idx
...
async function main() {
  ...
  console.log("Adding product_status_history indexes via Management API...");
